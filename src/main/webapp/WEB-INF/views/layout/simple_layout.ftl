...
<html lang="en">
	<head>
		...
		<link rel="shortcut icon" type="image/x-icon" href="static/plug/ace/assets/avatars/p.png" />
		...
		<script type="text/javascript">
			window.jQuery || document.write("<script src='static/plug/ace/assets/js/jquery-1.10.2.min.js'>"+"<"+"script>");
		</script>
		<!-- <![endif]-->
        ...
        <script type="text/javascript" src="static/plug/jquery/jquery-1.8.3.min.js"></script>
        <script type="text/javascript" src="static/plug/jquery/jquery.json.min.js"></script>

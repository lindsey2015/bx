...
public class UserServiceImpl implements UserService{
	...
	@Override
	public Page<User> findPageByTwoFieldsLikeOrderBy(Pageable pageable,
			String fieldName1, int fieldValue1, String fieldName2,
			String fieldValue2,String orderBy) {
		String sql = "select * from TB_USER where "+fieldName1+"="+fieldValue1+" and "+fieldName2+" LIKE '%"+fieldValue2+"%' order by "+orderBy;
		return userDao.findBySql(pageable,sql,User.class);
	}
	// 用户自定义结束，请不要修改以下内容

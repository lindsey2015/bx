...
public class FileUpload {
	...
	public static String DIR_IMAGE_UPLOAD = "/upload/images/";
	public static String DIR_EXCEL_UPLOAD = "/upload/excels/";
	public static String DIR_PDF_UPLOAD = "/upload/pdfs/";
	public static String DIR_DOC_UPLOAD = "/upload/docs/";
